...
export const createApply = async (req, res) => {
    try {
        const { restaurantName, description, email, phoneNumber, address } = req.body;
...
export const approveRejectApply = async (req, res) => {
    try {
...
export const applyDriver = async (req, res) => {
    try {
        const { name, email, phoneNumber, address, licenseNumber, vehicleType, vehicleNumber, licenseType, } = req.body;
        if (!name ||
            !email ||
            !phoneNumber ||
            !address ||
...
//# sourceMappingURL=apply.controllers.js.map