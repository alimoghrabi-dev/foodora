...
export const signupUser = async (req, res) => {
    try {
        const { name, email, nickname, phoneNumber, password, confirmPassword } = req.body;
...
export const checkIfEmailAlreadyUsed = async (req, res) => {
    try {
...
export const generateRegestrationToken = async (req, res) => {
    try {
        const { email } = req.body;
