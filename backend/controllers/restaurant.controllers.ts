...
import { ICartItem } from "../models/cartitem.model..js";
...
export const getRestaurantMenuItems = async (req: Request, res: Response) => {
  try {
...
export const completeInfo = async (req: Request, res: Response) => {
  try {
    const {
      deliveryTime,
      cuisine,
...
export const creatingVerificationLink = async (req: Request, res: Response) => {
  try {
    const restaurantId = req.userId;
...
export const publishStore = async (req: Request, res: Response) => {
  try {
    const restaurantId = req.userId;
...
export const editRestaurantInfo = async (req: Request, res: Response) => {
  try {
    const restaurantId = req.userId;
...
export const acceptAndReadyOrder = async (req: Request, res: Response) => {
  try {
    const restaurantId = req.userId;
    const { orderId } = req.body;
...
export const toggleRestaurant = async (req: Request, res: Response) => {
  try {
    const restaurantId = req.userId;
...
export const editRestaurantHours = async (req: Request, res: Response) => {
  try {
    const restaurantId = req.userId;
